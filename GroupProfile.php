			...
			<ul class="nav-notification clearfix">
				...
				<li class="profile dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a tabindex="-1" class="main-link logoutConfirm_open" href="GroupProfile.phplogoutConfirm"><i class="fa fa-lock fa-lg"></i> Log out</a></li>
					</ul>
				</li>
			</ul>
		</div><!-- /top-nav-->
		...
		<aside class="fixed skin-7">
			<div class="sidebar-inner scrollable-sidebar">
				<div class="size-toggle">
					...
					<a class="btn btn-sm pull-right logoutConfirm_open" href="GroupProfile.phplogoutConfirm">
		...
		<div id="main-container">
			<div id="row">
				<div class="col-xs-6 col-sm-6 option">
					...
					<a href='#' class='btn btn-xs btn-primary'>Leave Group</a>
				</div>
			</div>
					...
					<div class="col-md-3 col-sm-3">
						<div class="row">
							<div class="col-xs-6 col-sm-12 col-md-6">
								<strong class="font-14"><?php echo $groupname; ?></strong>
							</div>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-xs-6 text-center">
										<span class="block font-14"><?php echo countGroupMembers($groupid) ?></span>
										<small class="text-muted">Members</small>
									</div><!-- /.col -->
									<div class="col-xs-6 text-center">
										<span class="block font-14"><?php echo countGroupMessages($groupid) ?></span>
						...
						<div>
							<ul class="nav nav-list" id="myProfile">
								...
								while ($row = mysqli_fetch_array($query3)) {
									$mname = $row['fullname'];
									$matric = $row['member'];
									echo "<li><a href='profile2.php?tocheck=$matric'>$mname</a></li>";
								}
								?>
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="panel panel-default fadeInDown animation-delay3">
											<div class="panel-heading">
												<i class="fa fa-twitter"></i> Purpose...
											</div>
											<ul class="list-group">
