$(function () {
	...
	if (jQuery.type($.cookie('skin_color')) != 'undefined') {
		...
		$('#btnpost').removeClass('skin-1');
		$('#btnpost').removeClass('skin-2');
		$('#btnpost').removeClass('skin-3');
		$('#btnpost').removeClass('skin-4');
		$('#btnpost').removeClass('skin-5');
		$('#btnpost').removeClass('skin-6');
		$('#btnpost').removeClass('skin-7');
		$('#btnpost').removeClass('default');

		$('aside').addClass($.cookie('skin_color'));
		$('#top-nav').addClass($.cookie('skin_color'));
		$('btnpost').addClass($.cookie('skin_color'));
	}
